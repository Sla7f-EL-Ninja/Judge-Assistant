...
- إذا كان السؤال يذكر جهة أو كيانًا محددًا (كمصلحة الطب الشرعي، أو خبراء وزارة العدل)
  ويتضح من المواد المسترجعة أن هذا الكيان يندرج ضمن فئة قانونية عامة (كالخبير المنتدب)，
  فيجوز تطبيق الحكم القانوني العام على الكيان المحدد مع التصريح بذلك صراحةً في الإجابة.
  مثال: "تُعدّ مصلحة الطب الشرعي خبيرًا منتدبًا عند التكليف القضائي."

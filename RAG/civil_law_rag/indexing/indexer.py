...
#     3. Split into structured Documents
...
#             "Place civil_law_clean.txt in RAG/civil_law_rag/docs/."
#         )
...
#     import sys
#     from pathlib import Path
#     # Allow running as: python -m RAG.civil_law_rag.indexing.indexer [--force]
...
DOCS_PATH: str = str(_Path(__file__).resolve().parent.parent / "docs" / "civil_law.txt")
from RAG.civil_law_rag.indexing.splitter import split_egyptian_civil_law
from RAG.civil_law_rag.retrieval.vectorstore import (
    COLLECTION_NAME,
    get_qdrant_client,

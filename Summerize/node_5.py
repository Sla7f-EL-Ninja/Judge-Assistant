...
2. الوقائع غير المتنازع عليها: الوقائع الجوهرية المتعلقة بموضوع النزاع التي لم ينازع فيها أي طرف
   ...
   - استبعد: أسماء القضاة وأمناء السر، أرقام الجلسات والتأجيلات، أرقام البطاقات الشخصية والعناوين، تفاصيل الفحوص الإجرائية (تحليل الحبر، معامل التطابق، إجراءات الخبرة)
   - الحد الأقصى: فقرة واحدة متماسكة لا تتجاوز 100 كلمة
3. نقاط الخلاف الجوهرية: كل نقطة خلاف مع بيان موقف كل طرف باختصار
4. طلبات الخصوم: ما يطلبه كل طرف من المحكمة، مفصولاً بحسب الطرف — انسب كل طلب للطرف الذي قدّمه فعلاً

...
# ---------------------------------------------------------------------------
# Expected parties in the fixture case (Aligned with PartyEnum in schemas.py)
# ---------------------------------------------------------------------------
...
FIXTURE_PARTIES = [
    ...
    },
    {
        ...
        "aliases": [
            ...
            "رئيس محكمة القضاء الإداري بالإسماعيلية",
            "رئيس المحكمة الابتدائية",
            "لجنة التظلمات بالدائرة الأولى"
        ],
    }
]

# ---------------------------------------------------------------------------
# Expected documents based on the exact uploaded file names
# ---------------------------------------------------------------------------

...
def classify_evidence_node(state: Dict[str, Any]) -> Dict[str, Any]:
    ...
    prompt = f"{_EVIDENCE_SYSTEM}\n\n{_EVIDENCE_USER.format(elements_text=elements_text, retrieved_facts=retrieved_facts or 'لا وقائع متاحة', law_answer=law_answer or 'لا إطار قانوني متاح')}"

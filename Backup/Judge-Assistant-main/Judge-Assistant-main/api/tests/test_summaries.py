...
def _seed_case_and_summary(fake_db, case_id="case_sum"):
    ...
    loop.run_until_complete(fake_db["cases"].insert_one(case_doc))
    loop.run_until_complete(fake_db["summaries"].insert_one(summary_doc))
...
def test_get_summary_no_summary(client, fake_db):
    ...
    asyncio.get_event_loop().run_until_complete(
        fake_db["cases"].insert_one(case_doc)
    )
